  ...
  return (
    <div
      ...
      style={{
        ...
        transform: `perspective(1100px) rotateY(${angle}deg) translateZ(${R}px) ${hov ? 'scale(1.06)' : 'scale(1)'}`,
  ...
  return (
    <div className="relative" style={{ width:640, height:640, perspective:1100 }}>
      ...
      {[...Array(12)].map((_, i) => {
        ...
        return (
          <div key={i} aria-hidden="true" className="absolute rounded-full"
            style={{
              width: 4 + (i % 3) * 2, height: 4 + (i % 3) * 2,
              left: x, top: y,
              background: colors[i % 4], opacity: 0.4,
...
function ScaledOrbit() {
  ...
  return (
    <div ref={containerRef} className="w-full overflow-hidden" style={{ height: 640 * scale }}>
      <div style={{ width: 640, height: 640, transform: `scale(${scale})`, transformOrigin: 'top center', marginLeft: 'auto', marginRight: 'auto' }}>
        <OrbitScene />
      </div>
    </div>
  )
  ...
  return (
    <div className="relative overflow-hidden border-y border-white/[0.05] py-3" aria-hidden="true">
      <div className="flex gap-10 w-max" style={{ animation:'scroll 22s linear infinite' }}>
        {doubled.map((t,i) => (
          <span key={i} className="text-white/20 text-xs font-bold uppercase tracking-[0.18em] whitespace-nowrap flex items-center gap-3">
    ...
    <>
      <section ref={ref} className="relative min-h-screen flex items-center overflow-hidden">
        ...
        <motion.div style={{ y, opacity:op }}
          className="relative z-10 w-full max-w-7xl mx-auto px-6 pt-32 pb-10 grid grid-cols-1 lg:grid-cols-[1fr_640px] gap-8 items-center">
          ...
          <div>
            ...
            <motion.div
              ...
              className="inline-flex items-center gap-2 mb-6 sm:mb-8 px-3.5 py-1.5 rounded-full text-xs font-bold"
            ...
            <motion.p
              ...
              className="text-white/40 text-base md:text-xl max-w-md mb-8 md:mb-10 leading-relaxed"
            >
            ...
            >
              <button
                className="group relative flex items-center gap-2.5 font-black text-white text-sm md:text-base px-6 md:px-8 py-3.5 md:py-4 rounded-2xl overflow-hidden focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white"
              ...
              <button
                className="flex items-center gap-2 font-semibold text-white/60 hover:text-white text-sm md:text-base px-5 md:px-6 py-3.5 md:py-4 rounded-2xl border border-white/10 hover:border-white/20 transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/30"
            ...
            <motion.div initial={{ opacity:0 }} animate={{ opacity:1 }} transition={{ delay:0.85 }}
              ...
              {[{n:'+5k',l:'estudiantes'},{n:'4',l:'instituciones'},{n:'+200',l:'cursos'}].map(({n,l}) => (
                <div key={l} className="text-center">
                  <div className="text-xl md:text-2xl font-black" style={{ color:'#CC3366' }}>{n}</div>
